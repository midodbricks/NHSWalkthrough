...
dbdemos.install('lakehouse-hls-readmission', catalog='nhs_demos', schema='nhs_england_ml_demo')

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-hls-readmission-mike_dobing` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0918-211813-gp8i0a1u/configuration)). <br />
...
# MAGIC %run ../_resources/00-setup $reset_all_data=true $catalog=nhs_demos $db=nhs_england_ml_demo
...
spark.sql('use catalog nhs_demos');
spark.sql('use schema nhs_england_ml_demo')
...
# MAGIC
# MAGIC Open [the dbdemos_hls_patient_readmission model](https://adb-984752964297111.11.azuredatabricks.net/ml/experiments/2619274335421606?o=984752964297111&searchFilter=&orderByKey=metrics.%60val_f1_score%60&orderByAsc=false&startTime=ALL&lifecycleFilter=Active&modelVersionFilter=All+Runs&datasetsFilter=W10%3D) to explore its artifact and analyze the parameters used, including traceability to the notebook used for its creation.
