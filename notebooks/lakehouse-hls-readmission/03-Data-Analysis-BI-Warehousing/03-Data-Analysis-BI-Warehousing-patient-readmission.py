...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-hls-readmission-mike_dobing` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0626-103327-kzdtc29k/configuration)). <br />
...
# MAGIC %run ../_resources/00-setup $reset_all_data=false $catalog=nhs_demos $db=nhs_england_ml_demo
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&version=1">
...
# MAGIC %md
# MAGIC
# MAGIC Open the <a href="/sql/dashboards/40b7bf53-9bd6-47de-90d0-1cb11eeb6430" target="_blank">Cohort patient analysis Dashboard</a> to start reviewing our cohort data.
