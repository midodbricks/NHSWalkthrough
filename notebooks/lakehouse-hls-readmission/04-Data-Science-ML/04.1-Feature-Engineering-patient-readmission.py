...
spark.sql('use schema hls_patient_readmission')
...
training_dataset.write.mode('overwrite').saveAsTable("nhs_demos.nhs_england_ml_demo.training_dataset")
display(spark.table("nhs_demos.nhs_england_ml_demo.training_dataset"))
