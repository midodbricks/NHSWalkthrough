...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F05-Workflow-Orchestration%2F05-Workflow-Orchestration-patient-readmission&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F05-Workflow-Orchestration%2F05-Workflow-Orchestration-patient-readmission&version=1">
...
# MAGIC
# MAGIC <a dbdemos-workflow-id="init-job" href="/#job/862293014586025">Click here to access your Workflow job</a>, it was setup when you installed your demo.
# MAGIC
