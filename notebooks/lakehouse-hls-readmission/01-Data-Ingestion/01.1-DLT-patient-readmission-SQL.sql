...
-- MAGIC
-- MAGIC <!-- do not remove -->
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F01-Data-Ingestion%2F01.1-DLT-patient-readmission-SQL&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F01-Data-Ingestion%2F01.1-DLT-patient-readmission-SQL&version=1">
...
-- MAGIC
-- MAGIC
-- MAGIC The DLT pipeline was started for you! Click to <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/b589b350-7cab-4860-ab88-2a2ef4679611" target="_blank">open your Pipeline</a> and review its execution.
...
-- MAGIC
-- MAGIC Open the <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/b589b350-7cab-4860-ab88-2a2ef4679611" target="_blank">OMOP data model Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
