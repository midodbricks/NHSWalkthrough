...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F00-patient-readmission-introduction&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F00-patient-readmission-introduction&version=1">
...
# MAGIC %md 
# MAGIC
# MAGIC Open the HLS patient readmission  <a dbdemos-pipeline-id="dlt-patient-readmission" href="#joblist/pipelines/b589b350-7cab-4860-ab88-2a2ef4679611" target="_blank">Delta Live Table pipeline</a> or the [SQL notebook]($./01-Data-Ingestion/01.1-DLT-patient-readmission-SQL) *(python DLT notebook alternative coming soon).* <br>
